...
workflow {
    ...
    // // hardcoded thereshold:
    // picked_threshold = Channel.of(.03)
    ...
    postcode_results = "/hpc/scratch/hdd2/nv066607/work-breast-cancer-sample1-2/cd/e064865dfb3c4973e38137e6ced7e1/postcode_starfish_output.csv"
    decoder_html = DECODER_QC_PoSTcode(postcode_results, params.ExpMetaJSON)
